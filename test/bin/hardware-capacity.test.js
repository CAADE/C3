...
describe('hardware capacity Script Test Cases', function () {
  describe('Primary hardware capacity Test Case', function () {
    it('Primary hardware capacity Good Path', function (done) {
