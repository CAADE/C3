...
describe('Controller image list Test Cases', () => {
  describe('Primary Controller image list Test Case', () => {
    // Requires an environment and stack be list first.
    it('Primary Controller image list Good Path', (done) => {
      let url = 'http://localhost:1337/image/list?';
      let params = [];
