...
describe('Controller env update Test Cases', () => {
  describe('Primary Controller env update Test Case', () => {
    // Requires an environment and stack be update first.
    it('Primary Controller env update Good Path', (done) => {
      let url = 'http://localhost:1337/env/update?';
      let params = [];
