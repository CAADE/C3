...
describe('Controller user destroy Test Cases', () => {
  describe('Primary Controller user destroy Test Case', () => {
    // Requires an environment and stack be destroy first.
    it('Primary Controller user destroy Good Path', (done) => {
      let url = 'http://localhost:1337/user/destroy?';
      let params = [];
