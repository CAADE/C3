...
describe('Controller app get Test Cases', () => {
  describe('Primary Controller app get Test Case', () => {
    // Requires an environment and stack be get first.
    it('Primary Controller app get Good Path', (done) => {
      let url = 'http://localhost:1337/app/get?';
      let params = [];
