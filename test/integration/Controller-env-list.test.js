...
describe('Controller env list Test Cases', () => {
  describe('Primary Controller env list Test Case', () => {
    // Requires an environment and stack be list first.
    it('Primary Controller env list Good Path', (done) => {
      let url = 'http://localhost:1337/env/list?';
      let params = [];
