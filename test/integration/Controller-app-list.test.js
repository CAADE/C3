...
describe('Controller app list Test Cases', () => {
  describe('Primary Controller app list Test Case', () => {
    // Requires an environment and stack be list first.
    it('Primary Controller app list Good Path', (done) => {
      let url = 'http://localhost:1337/app/list?';
      let params = [];
